...
const DevJourney = () => {
  return (
    <Container id="dev" className="mt-20 ml-auto mr-auto">
      ...
      <SectionText>
        FreeCodeCamp. Codevolution (Vishwas). Traversy Media. Sam Meech-Ward.
        Fireship. WebDevSimplified. NetworkChuck. Theo-ping.GG Steve Griffith.
        Jack Herrington. Zach Gollwitzer. MonsterLessons. Hussein Nasser.
